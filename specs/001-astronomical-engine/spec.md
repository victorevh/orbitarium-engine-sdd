...
- Refinement: Scope is constrained to MVP (User Story 1) only; performance benchmarking, multi-scene loading, and advanced scaling/precision systems are deferred.
