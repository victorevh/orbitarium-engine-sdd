...
- [X] T009 Implement scene configuration schema in src/config/schema/scene-schema.ts
- [X] T010 Implement full-document validation with aggregated errors in src/core/validation/scene-validator.ts
